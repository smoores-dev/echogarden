...
let fliteModuleObject;
export async function synthesize(text, voice, voiceDir, rate, pitchMeanHz, pitchStdDev) {
...
function parseEventsFromTrace(eventTrace) {
    //log(eventTrace)
...
//# sourceMappingURL=FliteTTS.js.map