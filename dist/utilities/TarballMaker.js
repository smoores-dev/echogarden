...
export async function createNamedTarball(inputPath, name) {
...
export async function createTarballForEachDirIn(baseDir, namePrefix) {
...
export async function createTarballForEachFileIn(baseDir, namePrefix) {
