...
export async function computeMelSpectogram(rawAudio, fftOrder, windowSize, hopLength, filterbankCount, lowerFrequencyHz, upperFrequencyHz, windowType = 'hann') {
...
export async function computeMelSpectogramUsingFilterbanks(rawAudio, fftOrder, windowSize, hopLength, filterbanks, windowType = 'hann') {
    const logger = new Logger();
...
export function fftFramesToMelSpectogram(fftFrames, melFilterbanks) {
...
//# sourceMappingURL=MelSpectogram.js.map